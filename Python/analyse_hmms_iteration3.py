...
with open("pygocentrus_species.txt", 'r') as f:
            spp = f.readlines()
f.closed
...
for sp in spp:
    ...
    for directory in directories:
        ...
        if re.match(r'Recover_hmmlib2_.*',directory):
            #print(directory)
            os.chdir(directory)
            fastas = os.listdir('.')
                ...
                if '.DS_Store' not in fasta:
                    ...
                    if hmm_5end and hmm_3end:
                        ...
                        if int(hmm_5end[fasta][1]) < 10 and int(hmm_3end[fasta][1]) < 10:
                            ...
                            folder = re.sub(r'Recover_hmmlib2_','',directory)
                            ...
                            if end5 < end3:
                                ...
                                if AGT_total > AG_total:
                                    with open('../../' + species + "_recovered2_mavericks_AGTAGT.fa", 'a+') as o:
                                        print(curated_sequence, file=o)
                                    o.closed
                                else:
                                    with open('../../' + species + "_recovered2_mavericks_AGAGAG.fa", 'a+') as o:
                                        print(curated_sequence, file=o)
                                    o.closed

                                table = '../../' + species + '_recovered2_results.txt'
