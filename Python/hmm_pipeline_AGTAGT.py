...
of AGTAGT mavericks that could not be detected with maverick_miner.py"""
...
for sp in spp:
    ...
    for core in recovery_seqs.keys():
        ...
        for fasta in recovery_seqs[core]:
            ...
            cmd1 = 'nhmmer --noali --watson --tblout ' + dir_name + '/' + table_name1 + ' ' + species + '_5prime200_AGTAGT.hmm ' + core + '/' + fasta
            subprocess.run(cmd1, shell = True)
            table_name2 = re.sub(r'.fa','_crick.txt', fasta)
            cmd2 = 'nhmmer --noali --crick --tblout ' + dir_name + '/' + table_name2 + ' ' + species + '_5prime200_AGTAGT.hmm '  + core + '/' +  fasta
